<?php
session_start();
//OBAVEZNO MORA DA SE UKLJUCI DA BI COMPOSER FUNKCIONISAO
    ...
    if (empty($formErrors)) {
        ...
        try {
           ...
           // $mail->SMTPDebug = 2;                                   // Enable verbose debug output
            ...
            $mail->addAddress('tijanic@gmail.com', 'Ivan Tijanic');    // Add a recipient
            //$mail->addAddress('andere395@gmail.com');               // Name is optional
            ...
            $succesMessage = 'Message has been sent';
            $_SESSION['succesMessage'] = $succesMessage;
            header('Location: /kontakt-forma.php');
            die();
            
        } catch (PHPMailerException $ex) {
            $errorMessage= 'Error occured while sending email message.Please try again';
...
<?php if (!empty($succesMessage)) { ?>
                        <div class="alert alert-success alert-dismissible" role="alert">
                            ...
                            <span><?php echo htmlspecialchars($succesMessage); ?></span>
                        </div>
<?php } ?>
